...
namespace CommonCore.DataAccess.EntityFramework
{
    ...
    where TContext : DbContext
    {
        ...
        public virtual IList<TEntity> GetAll(bool lazyLoadingEnabled = true)
        {
        ...
        public async virtual Task<List<TEntity>> GetAllAsync(Expression<Func<TEntity, bool>> expression = null, bool lazyLoadingEnabled = true)
        {
            Context.ChangeTracker.LazyLoadingEnabled = lazyLoadingEnabled;
